...
//on first key press generate a random index number and present the related Object properties associated with that index number, AND create a line of underscores that match the number of charicters for the randomly guessed technique value.

// on subsequent key presses log them in an array variable, present that array on the screen to the player, present values in the array that match the winning technique name one at a time as a replacement for the underscores.
